...
editor = () => {
 ...
 var prevcursory = cursory;
  ...
  // space down + arrow pressed (create link between two basic blocks)
  if(s){
    if(U||R||D||L){
      if(space[prevcursorx][prevcursory][gridz] && space[prevcursorx][prevcursory][gridz].id == 0 && space[cursorx][cursory][gridz] && space[cursorx][cursory][gridz].id == 0){
