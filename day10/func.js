...
var links = () => {
  for(i of roadlinks){
    ...
    if(i[0][0] == i[1][0] && i[0][2] == i[1][2] && i[0][1] == i[1][1] - 1){
      C.plane({w:size,h:1,x:i[0][0]*size,y:i[0][1]*size+size*.9,z:.2,b:"#d90",o:"top left",css:"barrierleftright"});
    ...
    if(i[0][0] == i[1][0] && i[0][2] == i[1][2] && i[0][1] == i[1][1] + 1){
      C.plane({w:size,h:1,x:i[1][0]*size,y:i[1][1]*size+size*.9,z:.2,b:"#d90",o:"top left",css:"barrierleftright"});
