...
var barriers = i => {
  ...
  if(z == 0){
    ...
    if(block){
      ...
      if(block.barriers.u){
       C.$(`road-${x}-${y}-${z}`).style.borderTop = "5px solid #000";
      ...
      if(block.barriers.d){
       C.$(`road-${x}-${y}-${z}`).style.borderBottom = "5px solid #000";
      ...
      if(block.barriers.l){
       C.$(`road-${x}-${y}-${z}`).style.borderLeft = "5px solid #000";
      ...
      if(block.barriers.r){
       C.$(`road-${x}-${y}-${z}`).style.borderRight = "5px solid #000";
  ...
  for(i of roadlinks){
    ...
    if(i){
      ...
      if(i[0][0] == i[1][0] && i[0][2] == i[1][2] && i[0][1] == i[1][1] - 1){
        C.plane({w:size*.8,h:size*.2,x:i[0][0]*size+size*.1,y:i[0][1]*size+size*.9,z:.2,b:"#d90",o:"top left",css:"barrierleftright"});
      ...
      if(i[0][0] == i[1][0] && i[0][2] == i[1][2] && i[0][1] == i[1][1] + 1){
        C.plane({w:size*.8,h:size*.2,x:i[1][0]*size+size*.1,y:i[1][1]*size+size*.9,z:.2,b:"#d90",o:"top left",css:"barrierleftright"});
      ...
      if(i[0][0] == i[1][0] - 1 && i[0][2] == i[1][2] && i[0][1] == i[1][1]){
        C.plane({w:size*.2,h:size*.8,x:i[0][0]*size+size*.9,y:i[1][1]*size+size*.1,z:.2,b:"#d90",o:"top left",css:"barriertopbottom"});
      ...
      if(i[0][0] == i[1][0] + 1 && i[0][2] == i[1][2] && i[0][1] == i[1][1]){
        C.plane({w:size*.2,h:size*.8,x:i[1][0]*size+size*.9,y:i[1][1]*size+size*.1,z:.2,b:"#d90",o:"top left",css:"barriertopbottom"});
  ...
  for(i of roads){
    if(i){
      ...
      if(block.u && block.r && !block.d && !block.l){
        ...
        if(C.$(`road-${x}-${y}-${z}`)){
          C.$(`road-${x}-${y}-${z}`).style.borderRadius = "0";
          block.flat.u = 0;
          block.flat.r = 0;
          block.flat.d = 0;
          block.flat.l = 0;
